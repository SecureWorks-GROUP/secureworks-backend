...
//
// Tell Jarvis note box (ops.html submitJarvisContext / add_job_context) is a
// confirmed dead write. Owner: docs/project-knowledge/ops-dashboard.md. Do not
// implement add_job_context here.
...
export function reportingApiStaffOperatorRole(role: unknown): boolean {
  return REPORTING_API_STAFF_OPERATOR_ROLES.has(
