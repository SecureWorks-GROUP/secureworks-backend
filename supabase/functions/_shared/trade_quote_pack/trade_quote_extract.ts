...
export function tradeQuoteExtractHtmlMoneyNeedles(html: string): string[] {
  ...
  // Drop the whole Payment terms row after the allowlist check. The <dt>
  // label is "Payment terms"; leaving it would false-hit payment/pay.
  const stripped = String(html || "")
    .replace(EXTRACT_HTML_STYLE_BLOCK, "")
    .replace(EXTRACT_HTML_PAYMENT_TERMS_ROW, "")
