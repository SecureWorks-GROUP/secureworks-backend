-- ════════════════════════════════════════════════════════════════
-- Cap 1C state_engine_observations table
-- Promoted from supabase/migrations/_drafts/state_engine_observations_draft.sql
-- on 2026-05-03 after Marnin approval.
--
-- Authority:
...
--
-- Behaviour contract:
--   • Append-only by convention (REVOKE UPDATE/DELETE on authenticated/anon).
--   • RLS service-role-only.
--   • Three composite indexes for the documented query patterns.
--   • Inline rollback DDL at the bottom.
--
