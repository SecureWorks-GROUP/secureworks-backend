-- The 20260911171000 repository body of resolve_context_attribution (md5(prosrc)
-- 9214e779cf7d19c69327171c640bba95), for proving the forward guard also accepts a database built from
...
BEGIN
 IF (SELECT md5(prosrc) FROM pg_proc WHERE oid='public.resolve_context_attribution(public.business_events)'::regprocedure)
  <>'9214e779cf7d19c69327171c640bba95' THEN RAISE EXCEPTION 'L1 fixture: repository pre-image is not the 20260911171000 body'; END IF;
END $$;
