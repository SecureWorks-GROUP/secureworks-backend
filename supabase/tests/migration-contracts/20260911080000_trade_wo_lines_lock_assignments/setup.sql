...
INSERT INTO public.trade_invoice_lines (
  trade_invoice_id, job_id, job_number, line_type, description, line_total_ex, source_work_order_id
) VALUES
  ('e4000000-0000-4000-8000-000000000001', 'e2000000-0000-4000-8000-000000000001', 'SWF-WOLOCK-261063',
   'work order', 'Work order $1477.00. Less labour: Sonny 14.5h x $35 = $507.50. Net payable $969.50', 969.50, NULL),
  ...
  ('e4000000-0000-4000-8000-000000000006', 'e2000000-0000-4000-8000-000000000002', 'SWF-WOLOCK-RELEASED',
   'crew_work_order_deduction', 'Less: crew charge', -50, 'e3000000-0000-4000-8000-000000000004');
