...
BEGIN
 ...
 IF to_regprocedure('public.context_reconsider_contact(text,timestamptz,text,uuid)') IS NOT NULL THEN RAISE EXCEPTION 'rollback: context_reconsider_contact remains'; END IF;
