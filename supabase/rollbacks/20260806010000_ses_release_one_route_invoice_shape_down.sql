-- Rollback: restore commit_ses_release_revision_v1 to the pre-2026-08-06 body,
-- which accepts only 3-route universal and 2-route AJS shapes. Reverting this
-- makes every ruled one-route roof-report release refuse at the database again.
-- Body below is the exact prior definition from
-- 20260804090000_ses_release_report_invoice_route_kind.sql.
