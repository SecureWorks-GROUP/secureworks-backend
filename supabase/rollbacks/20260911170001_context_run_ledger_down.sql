...
REVOKE EXECUTE ON FUNCTION public.reserve_context_model_call(text,uuid,uuid),public.claim_context_extraction_run(uuid,date,text),public.claim_context_pass(date),public.renew_context_pass(date,uuid) FROM service_role;
