-- Down for 20260923120000: restore the 20260911171000 ladder body (step 1 matches
-- any xero_invoices.invoice_number and any holding job again). No rows are moved
-- either way; rows placed under L1 keep their placement.
