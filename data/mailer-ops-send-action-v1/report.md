...
| Tests | `supabase/functions/ops-api/ses_mailer_ops_send_test.ts` (36 pass, **zero Graph**) |
...
The mail gateway is mocked in tests. **36/36 wiring tests pass with zero outbound Graph calls.**  
