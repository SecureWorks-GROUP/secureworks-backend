...
context_pipeline_status_migration_sha() {
...
context_pipeline_status_row = {
    "function_name": "ops-api",
    "migration_version": "20260917210000",
    "expected_migration_name": "context_pipeline_status",
    "expected_statement_sha256": os.environ["CONTEXT_PIPELINE_STATUS_EXPECTED_SHA"],
    "actual_migration_version": "20260917210000",
    "actual_migration_name": "context_pipeline_status",
    "actual_statement_count": 4,
    "actual_statement_sha256": None,
    "missing_markers": [],
}
