...
- **Appointment write** (default-off): `create_calendar_appointment`; stuck sending rows: `release_calendar_appointment_request`. Owner: `docs/ghl-calendar-appointment-write.md`.
