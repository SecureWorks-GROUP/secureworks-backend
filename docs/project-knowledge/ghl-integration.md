...
- `create_contact_and_opportunity`, `lookup_allocation_opportunity` — contact + opportunity create and contact-scoped Stratco allocation-ref lookup. See `edge-functions.md`.
